  ...
  return (
    <div className="w-full">
      <Helmet>
        ...
        <link rel="canonical" href={`https://www.d2dspot.com/blog/${id}`} />
        <meta property="og:title" content={blog.title} />
        <meta property="og:description" content={blog.excerpt} />
        <meta property="og:url" content={`https://www.d2dspot.com/blog/${id}`} />
        <meta property="og:image" content={blog.image ? `https://www.d2dspot.com${blog.image}` : "https://www.d2dspot.com/assets/d2dspot.png"} />
